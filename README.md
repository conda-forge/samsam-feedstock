...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/samsam-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13583&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/samsam-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `samsam` can be installed with:

```
conda install samsam
```

It is possible to list all of the versions of `samsam` available on your platform with:
